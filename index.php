...
<head>
    ...
    <meta name="description" content="Gear Kiosk helps classrooms manage shared equipment checkouts, returns, and student access from a single kiosk.">
    <meta name="theme-color" content="#2563eb">
    <meta name="mobile-web-app-capable" content="yes">
    <meta name="apple-mobile-web-app-capable" content="yes">
    <meta name="apple-mobile-web-app-status-bar-style" content="default">
    <meta name="apple-mobile-web-app-title" content="Gear Kiosk">
                    ...
                    <section class="admin-section">
                        <h3>
                            ...
                            <div style="margin-left: auto; display: flex; gap: 0.25rem;">
                                <button id="printRosterBtn" class="btn-icon-small print" title="Print Student Roster">
                                    <i data-lucide="printer"></i>
                                </button>
                                <button id="bulkImportBtn" class="btn-icon-small" title="Bulk Import from CSV/TSV">
